              ...
              child: Obx(
                () => ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Padding(
                      padding:
                          EdgeInsets.only(right: 2.w, left: 2.w, bottom: 3.h),
                      child: InkWell(
                        onTap: () {
                          Get.to(() => CemeteryDetailsView(), arguments: {
                            "cemeteryID": controller.cemeteryList[index].id,
                            "storeLatitude": double.parse(
                                controller.cemeteryList[index].latitude),
                            "storeLongitude": double.parse(
                                controller.cemeteryList[index].longitude),
                            "cemeteryName": controller.cemeteryList[index].name,
                            "cemeteryContactNumber": controller
                                .cemeteryList[index].contactNumber
                                .toString(),
                            "cemeteryAddress":
                                controller.cemeteryList[index].address
                          });
                        },
                        child: Container(
                          height: 23.h,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      controller.cemeteryList[index].name,
                                      style: TextStyle(
